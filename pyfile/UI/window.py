...
from PySide6.QtWidgets import (QApplication, QFrame, QGridLayout, QListView,
                               ...
                               QStatusBar, QTextBrowser, QWidget, QDialog, QVBoxLayout, QLabel)
import webbrowser
...
class InfoDialog(QDialog):
  def __init__(self, parent=None):
    ...
    version_label = QLabel("バージョン: 1.1.0")
    layout.addWidget(version_label)

    code_button = QPushButton("コード")
    code_button.clicked.connect(self.open_github)
    layout.addWidget(code_button)

    self.setLayout(layout)

  def open_github(self):
    webbrowser.open("https://github.com/hisa11/QRmanager")
...
class Ui_MainWindow(object):
  def setupUi(self, MainWindow):
    ...
    self.gridLayout.addWidget(self.info_button, 0, 3, 1, 1)
  ...
  def retranslateUi(self, MainWindow):
    ...
    self.debise.setText(QCoreApplication.translate(
        "MainWindow", u"\u767b\u9332\u6a5f\u5668\u4e00\u89a7", None))
    self.new_debise.setText(QCoreApplication.translate(
        "MainWindow", u"\u6a5f\u5668\u767b\u9332", None))
    self.info_button.setText(
        QCoreApplication.translate("MainWindow", u"情報", None))
